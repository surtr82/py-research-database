...
class SiteForm(FlaskForm):
    ...
    is_registered = BooleanField('Registered')
    is_georeference_confirmed = BooleanField('Georerefence confirmed')
    is_georeference_outside_research_area = BooleanField('Outside research area')
    is_looted = BooleanField('Looted')
    certainty_score_id = SelectField('Certainty Score', coerce=int, validators=[DataRequired()])
    corona_settlement_score_id = SelectField('Corona Settlement Score', coerce=int, validators=[DataRequired()])
    bing_settlement_score_id = SelectField('Bing Settlement Score', coerce=int, validators=[DataRequired()])
    corona_agriculture_score_id = SelectField('Corona Agriculture Score', coerce=int, validators=[DataRequired()])
    bing_agriculture_score_id = SelectField('Bing Agriculture Score', coerce=int, validators=[DataRequired()])
