...
class SiteForm(FlaskForm):
    ...
    corona_tell_condition = FloatField('Tell Condition 1969')
    corona_lowertown_condition = FloatField('Lowertown Condition 1969')
    bing_tell_condition = FloatField('Tell Condition 2022')
