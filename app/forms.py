...
class SiteForm(FlaskForm):
    ...
    corona_condition_score_id = SelectField('Corona Condition Score', coerce=int, validators=[DataRequired()])
    bing_condition_score_id = SelectField('Bing Condition Score', coerce=int, validators=[DataRequired()])
